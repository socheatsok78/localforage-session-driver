// If IndexedDB isn't available, we'll fall back to sessionStorage.
...
function checkIfLocalStorageThrows() {
    ...
    try {
        sessionStorage.setItem(localStorageTestKey, true);
        sessionStorage.removeItem(localStorageTestKey);
...
function _isLocalStorageUsable() {
    return !checkIfLocalStorageThrows() || sessionStorage.length > 0;
}
